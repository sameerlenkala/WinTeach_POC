...
/* ── CSS ─────────────────────────────────────────────────────── */
const SLOG_CSS = `
.slog-root{font-family:var(--font-sans,"DM Sans"),ui-sans-serif,system-ui,-apple-system,sans-serif;font-size:14px;line-height:1.5;color:var(--ink-1);-webkit-font-smoothing:antialiased;display:flex;flex-direction:column;height:100%;min-height:0;background:var(--paper);overflow:hidden;}
.slog-root *,.slog-root *::before,.slog-root *::after{box-sizing:border-box;}
.slog-root h1,.slog-root h2,.slog-root h3,.slog-root h4,.slog-root h5,.slog-root h6{font-family:var(--font-heading);font-weight:600;}
.slog-root button{font-family:inherit;cursor:pointer;}
.slog-root input,.slog-root textarea,.slog-root select{font-family:inherit;color:inherit;}
.slog-root ::selection{background:var(--accent-tint);color:var(--ink-1);}
.slog-root{
/* ── Winnify design-token bridge ── */
--color-primary:var(--brand,#6C5CE7);--color-primary-hover:var(--brand-hover,#5B4BDB);--color-primary-tint:color-mix(in oklab,var(--brand,#6C5CE7) 10%,transparent);--color-primary-tint-2:color-mix(in oklab,var(--brand,#6C5CE7) 18%,transparent);--color-primary-fg:#ffffff;
--color-background:var(--app-bg);--color-card:var(--card);--color-muted:var(--surface-muted);--color-muted-2:var(--app-bg);
--color-foreground:var(--text);--color-muted-foreground:var(--text-muted);--color-foreground-2:var(--text);--color-foreground-3:var(--text-muted);--color-foreground-4:var(--border);
--color-border:var(--border);--color-border-2:var(--border);--color-border-strong:var(--text-muted);
--color-w-green:#88b033;--color-w-green-tint:rgba(136,176,51,0.12);--color-w-blue:#48aabe;--color-w-blue-tint:rgba(72,170,190,0.12);
--color-w-orange:#ed9035;--color-w-orange-tint:rgba(237,144,53,0.12);--color-destructive:#DC2133;--color-destructive-tint:rgba(220,33,51,0.10);
--paper:var(--app-bg);--surface:var(--card);--surface-2:var(--app-bg);--surface-3:var(--surface-muted);--overlay:rgba(0,0,0,0.45);
--ink-1:var(--text);--ink-2:var(--text);--ink-3:var(--text-muted);--ink-4:var(--text-muted);--ink-5:var(--border);
--line-1:var(--border);--line-2:var(--border);--line-strong:var(--text-muted);
--accent:var(--brand,#5B4BDB);--accent-hover:color-mix(in oklab,var(--brand,#5B4BDB) 85%,black);--accent-tint:color-mix(in oklab,var(--brand,#5B4BDB) 10%,transparent);--accent-text-on:#ffffff;
--powerplay:#48aabe;--powerplay-tint:rgba(72,170,190,0.12);--powerplay-deep:#2c7585;
--acceleration:#ed9035;--acceleration-tint:rgba(237,144,53,0.12);--acceleration-deep:#b06715;
--final-over:var(--brand,#5B4BDB);--final-over-tint:color-mix(in oklab,var(--brand,#5B4BDB) 10%,transparent);--final-over-deep:color-mix(in oklab,var(--brand,#5B4BDB) 70%,black);
--success:#88b033;--success-tint:rgba(136,176,51,0.12);--success-deep:#5d7a22;
--warn:#ed9035;--warn-tint:rgba(237,144,53,0.12);--danger:#DC2133;--danger-tint:rgba(220,33,51,0.10);
--heat-0:var(--surface-muted);--heat-1:color-mix(in oklab,var(--brand,#5B4BDB) 12%,transparent);--heat-2:color-mix(in oklab,var(--brand,#5B4BDB) 30%,transparent);--heat-3:color-mix(in oklab,var(--brand,#5B4BDB) 60%,transparent);--heat-4:var(--brand,#5B4BDB);
--font-heading:var(--font-display,"Fredoka"),"Plus Jakarta Sans",ui-sans-serif,system-ui,sans-serif;
--font-body:var(--font-sans,"DM Sans"),ui-sans-serif,system-ui,sans-serif;
--font-mono:ui-monospace,"SF Mono",Menlo,Monaco,Consolas,monospace;
--font-sans:var(--font-sans,"DM Sans"),ui-sans-serif,system-ui,sans-serif;
--shadow-1:0 1px 0 rgba(0,0,0,.03),0 1px 2px rgba(0,0,0,.04);
--shadow-2:0 2px 4px rgba(0,0,0,.04),0 8px 24px rgba(0,0,0,.06);
...
.topbar{display:flex;align-items:center;gap:16px;padding:14px 32px;border-bottom:1px solid var(--line-1);background:var(--paper);min-height:56px;flex-shrink:0;overflow:hidden;}
.topbar .crumbs{display:flex;align-items:center;gap:8px;font-size:12.5px;color:var(--ink-3);font-family:var(--font-mono);min-width:0;overflow:hidden;}
.topbar .crumbs .sep{color:var(--ink-5);flex-shrink:0;}
.topbar .crumbs .here{color:var(--ink-1);overflow:hidden;text-overflow:ellipsis;white-space:nowrap;}
.topbar .right{margin-left:auto;display:flex;align-items:center;gap:10px;flex-shrink:0;}
.viewport{flex:1;overflow:auto;position:relative;min-height:0;}
.viewport-inner{max-width:1080px;margin:0 auto;padding:32px;word-break:break-word;}
.page-h{display:flex;align-items:flex-start;justify-content:space-between;gap:24px;margin-bottom:24px;flex-wrap:wrap;}
.page-h h1{font-family:var(--font-heading);font-size:28px;font-weight:600;letter-spacing:-0.02em;line-height:1.2;margin:0 0 4px;}
.page-h .sub{color:var(--ink-3);font-size:13.5px;max-width:60ch;line-height:1.5;}
.page-h .actions{display:flex;gap:8px;flex-shrink:0;}
.h-display{font-family:var(--font-heading);font-weight:700;font-size:40px;letter-spacing:-0.025em;line-height:1.1;display:block;position:relative;}
.slog-h2{font-family:var(--font-heading);font-size:22px;font-weight:600;letter-spacing:-0.015em;line-height:1.3;margin:0;display:block;position:relative;z-index:1;}
.slog-h3{font-family:var(--font-heading);font-size:16px;font-weight:600;letter-spacing:-0.01em;line-height:1.4;margin:0;display:block;position:relative;z-index:1;}
.mono{font-family:var(--font-mono);}
.label{font-family:var(--font-mono);font-size:10.5px;letter-spacing:.08em;text-transform:uppercase;color:var(--ink-3);}
.muted{color:var(--ink-3);}
.dim{color:var(--ink-4);}
.btn{display:inline-flex;align-items:center;gap:8px;padding:8px 14px;border-radius:8px;font-size:13px;font-weight:500;white-space:nowrap;border:1px solid var(--line-2);background:var(--surface);color:var(--ink-1);transition:background .15s var(--ease),border-color .15s var(--ease);}
.btn:hover{background:var(--surface-3);}
.btn-primary{background:var(--ink-1);color:var(--paper);border-color:var(--ink-1);}
.btn-primary:hover{background:#000;}
.btn-accent{background:var(--accent);color:var(--accent-text-on);border-color:var(--accent);}
...
.card{background:var(--surface);border:1px solid var(--line-1);border-radius:12px;overflow:hidden;word-break:break-word;}
.card-pad{padding:20px;display:flex;flex-direction:column;}
...
.chip{display:inline-flex;align-items:center;gap:6px;padding:3px 8px;border-radius:999px;background:var(--surface-3);color:var(--ink-2);font-size:11.5px;border:1px solid transparent;font-family:var(--font-mono);letter-spacing:.02em;}
...
.chip-power{background:var(--powerplay-tint);color:var(--powerplay-deep);}
.chip-accel{background:var(--acceleration-tint);color:var(--acceleration-deep);}
.chip-final{background:var(--final-over-tint);color:var(--final-over-deep);}
.chip-success{background:var(--success-tint);color:var(--success);}
.chip-warn{background:var(--warn-tint);color:var(--acceleration-deep);}
...
.progress>span{display:block;height:100%;background:var(--ink-1);border-radius:999px;transition:width .6s var(--ease);}
.progress.thick{height:6px;}
.progress.power>span{background:var(--powerplay);}
.progress.accel>span{background:var(--acceleration);}
.progress.final>span{background:var(--final-over);}
...
.input,.select,.textarea{background:var(--surface);border:1px solid var(--line-2);border-radius:8px;padding:10px 12px;font-size:13.5px;color:var(--ink-1);outline:none;transition:border-color .15s var(--ease);}
.input:focus,.select:focus,.textarea:focus{border-color:var(--ink-2);box-shadow:0 0 0 3px rgba(20,18,14,.06);}
.modal-scrim{position:fixed;inset:0;background:var(--overlay);backdrop-filter:blur(6px);display:grid;place-items:center;z-index:50;animation:soFade .2s var(--ease);}
.modal{background:var(--surface);border-radius:16px;border:1px solid var(--line-1);width:min(520px,92vw);box-shadow:var(--shadow-pop);animation:soPop .25s var(--ease-out);overflow:hidden;display:flex;flex-direction:column;max-height:90vh;}
.modal-lg{width:min(720px,92vw);}
.modal-pad{padding:24px;overflow-y:auto;}
.modal-head{padding:24px 24px 16px;flex-shrink:0;border-bottom:1px solid var(--line-1);}
.modal-foot{padding:16px 24px;background:var(--surface-2);border-top:1px solid var(--line-1);display:flex;justify-content:flex-end;gap:8px;flex-shrink:0;}
@keyframes soFade{from{opacity:0}to{opacity:1}}
@keyframes soPop{from{opacity:0;transform:translateY(8px) scale(.98)}to{opacity:1;transform:none}}
.banner{display:flex;align-items:center;gap:12px;padding:10px 14px;border-radius:8px;border:1px solid var(--line-2);background:var(--surface);font-size:13px;}
.banner.warn{background:var(--warn-tint);border-color:#f5c89a;}
.banner.danger{background:var(--danger-tint);border-color:#f7a8ad;}
.banner.info{background:var(--accent-tint);border-color:var(--color-primary-tint-2,var(--line-2));}
.tabs{display:flex;gap:2px;border-bottom:1px solid var(--line-1);}
.tab{padding:10px 14px;background:transparent;border:0;font-size:13px;color:var(--ink-3);border-bottom:2px solid transparent;margin-bottom:-1px;cursor:pointer;}
.tab:hover{color:var(--ink-1);}
.tab.active{color:var(--ink-1);border-bottom-color:var(--ink-1);}
.segmented{display:inline-flex;padding:3px;background:var(--surface-3);border-radius:8px;gap:2px;}
.segmented button{padding:5px 12px;border:0;background:transparent;border-radius:6px;font-size:12.5px;color:var(--ink-3);cursor:pointer;font-family:inherit;}
.segmented button.active{background:var(--surface);color:var(--ink-1);box-shadow:var(--shadow-1);}
...
.heatcell{aspect-ratio:1;border-radius:3px;background:var(--heat-0);border:1px solid rgba(20,18,14,.02);}
.heatcell.h1{background:var(--heat-1);}.heatcell.h2{background:var(--heat-2);}.heatcell.h3{background:var(--heat-3);}.heatcell.h4{background:var(--heat-4);}
.divider{height:1px;background:var(--line-1);width:100%;}
.fade-in{animation:soFadeUp .35s var(--ease-out);}
@keyframes soFadeUp{from{opacity:0;transform:translateY(6px)}to{opacity:1;transform:none}}
.phase-strip{display:flex;align-items:center;justify-content:space-between;padding:18px 22px;border-radius:12px;border:1px solid var(--line-1);background:var(--surface);}
.phase-strip.power{background:linear-gradient(180deg,var(--powerplay-tint),var(--surface));}
.phase-strip.accel{background:linear-gradient(180deg,var(--acceleration-tint),var(--surface));}
.phase-strip.final{background:linear-gradient(180deg,var(--final-over-tint),var(--surface));}
.tint-power{background:linear-gradient(180deg,var(--powerplay-tint),var(--surface));}
.tint-accel{background:linear-gradient(180deg,var(--acceleration-tint),var(--surface));}
.tint-final{background:linear-gradient(180deg,var(--final-over-tint),var(--surface));}
.skel{background:linear-gradient(90deg,var(--surface-3) 0%,var(--line-1) 50%,var(--surface-3) 100%);background-size:200% 100%;animation:shimmer 1.4s linear infinite;border-radius:6px;}
@keyframes shimmer{from{background-position:200% 0}to{background-position:-200% 0}}
.toast{position:fixed;bottom:24px;left:50%;transform:translateX(-50%);background:var(--ink-1);color:var(--paper);padding:10px 16px;border-radius:999px;font-size:13px;z-index:60;box-shadow:var(--shadow-pop);display:flex;align-items:center;gap:10px;animation:soPop .25s var(--ease-out);}
.kvgrid{display:grid;grid-template-columns:max-content 1fr;gap:6px 18px;font-size:13px;}
.kvgrid dt{color:var(--ink-3);}.kvgrid dd{margin:0;color:var(--ink-1);}
`;
...
function seedHeatmap(bias = 0.45): number[] {
  const cells: number[] = [];
...
// Topbar (breadcrumbs)
// ───────────────────────────────────────────────────────────────────────────
function Topbar({crumbs = [], right = null }: any) {
  return (
...
// Modal
// ───────────────────────────────────────────────────────────────────────────
function Modal({open, onClose, children, size = "" }: any) {
  useEffect(() => {
    if (!open) return;
...
function Placeholder({label = "preview", h = 120 }: any) {
  return (
    <div style={{
    ...
    <>
      ...
      <UI.Modal open={showEmpty} onClose={() => { setShowEmpty(false); setState({ firstVisit: false }); }}>
        <div className="modal-head">
          ...
          <h2 className="slog-h2 mt-2">Build a study plan that adapts to your interview window</h2>
      ...
      <UI.Modal open={showExplainer} onClose={() => setShowExplainer(false)} size="modal-lg">
        <div className="modal-head">
          ...
          <h2 className="slog-h2 mt-2">A unified, time-aware interview prep loop</h2>
        </div>
        <div className="modal-pad" style={{paddingTop: 0}}>
          <div className="row gap-3 wrap">
            {[
              ...
              <div key={x.t} className={`card card-pad tint-${x.c}`} style={{flex:"1 1 200px"}}>
                ...
                <div className="slog-h3 mt-2">{x.t}</div>
...
function EmptyHero({onStart, onLearn }: any) {
  return (
...
function SessionGroup({title, rows }: any) {
        ...
        <div className="row between gap-4">
          <div className="col" style={{gap: 6, minWidth: 0, flex: 1}}>
            ...
            <div className="row gap-3">
              <div className="slog-h2" style={{fontSize: 20}}>{s.role}</div>
          ...
          <div className="col" style={{alignItems: "flex-end", gap: 4}}>
            ...
            <div className="slog-h2 mono" style={{fontSize: 24, letterSpacing: "-0.02em"}}>
...
(window as any).ScreenSessionsList = ScreenSessionsList;

// SO-03 / SO-04 / SO-05 setup wizard + SO-06 generating + SO-23 duplicate warning
function SetupShell({step, children, draft, setDraft, onBack, onNext, nextLabel = "Next", nextDisabled = false, error = "" }: any) {
  return (
    <>
      <UI.Topbar
    ...
    <SetupShell step={3} onBack={() => go("slog:setup-2")} onNext={onGenerate} nextLabel="Start my Slog Over">
      ...
      <div className="card mt-6" style={{padding: 22}}>
        <div className="row gap-6 wrap">
          <div className="col gap-2">
            ...
            <div className="slog-h3">{draft.role}</div>
          </div>
          <div className="col gap-2">
            <div className="label">Company</div>
            <div className="slog-h3">{draft.company || <span className="dim">None</span>}</div>
          </div>
          <div className="col gap-2">
            <div className="label">Days remaining</div>
            <div className="slog-h3 mono">{dl}</div>
          </div>
          <div className="col gap-2">
            <div className="label">Target date</div>
            <div className="slog-h3 mono">{WUTIL.fmtDate(draft.targetDate)}</div>
          </div>
          {draft.oaSubType && (
            <div className="col gap-2">
              <div className="label">OA sub-type</div>
              <div className="slog-h3" style={{textTransform: "capitalize"}}>{draft.oaSubType.replace("_"," ")}</div>
            </div>
          )}
        </div>
          ...
          {["powerplay","acceleration","finalOver"].map(k => {
            ...
            return (
              <div key={k} className={`card card-pad tint-${tone}`} style={{flex: "1 1 220px", opacity: skipped ? .5 : 1}}>
                ...
                <div className="slog-h3 mt-3">{WUTIL.phaseLabel(k === "finalOver" ? "final-over" : k)}</div>
      ...
      <UI.Modal open={showConflict} onClose={() => setShowConflict(false)}>
        <div className="modal-head">
          ...
          <h2 className="slog-h2 mt-2">You're starting in {pendingPhase ? WUTIL.phaseLabel(pendingPhase) : ""}, not {WUTIL.phaseLabel(aiPhase)}</h2>
        </div>
        <div className="modal-pad" style={{paddingTop: 0}}>
...
(window as any).ScreenSetup1 = ScreenSetup1;
(window as any).ScreenSetup2 = ScreenSetup2;
(window as any).ScreenSetup3 = ScreenSetup3;
(window as any).GeneratingOverlay = GeneratingOverlay;
...
function SessionHeader({s, expired, dl }: any) {
  const foDisplay = (window.FO && FO.isComplete(s)) ? 1 : 0;
  const overall = (s.phases.powerplay.progress * 0.4 + s.phases.acceleration.progress * 0.35 + foDisplay * 0.25);
  return (
...
function MilestoneView({s, variant }: any) {
  return (
    <>
      <div className="row between" style={{marginBottom: 12}}>
...
function ClusterChip({label, v }: any) {
  return (
...
function MilestoneTimeline({s }: any) {
  const { go } = useApp();
  ...
  return (
    <div className="card card-pad">
      <div className="row between">
        <div>
          <div className="slog-h3">Plan window</div>
...
function MilestoneRings({s }: any) {
  ...
  return (
    <div className="col gap-3">
      ...
      <div className="card card-pad">
        <div className="row between">
          <div className="slog-h3">Foundation · user-level</div>
        ...
        <div className="row gap-3 wrap mt-4">
          {[
            ...
            <button key={key} className="card card-hover" style={{flex: "1 1 180px", padding: 14, textAlign: "left", background: "var(--surface-2)", cursor: "pointer", border: "1px solid var(--line-1)"}}
              ...
              <div className="row between">
                <span className="slog-h3" style={{fontSize: 14}}>{label}</span>
...
function Ring({value, color, size = 100, stroke = 8 }: any) {
...
function DayView({s }: any) {
  ...
  const TasksBlock = (
    <div className="card card-pad">
      <div className="row between">
        <div>
          <div className="slog-h3">Today · {new Date().toLocaleDateString("en-IN", { weekday: "long", day: "numeric", month: "long" })}</div>
      ...
      <div className="col gap-2 mt-4">
        ...
        {tasks.length === 0 && (
          <div className="card card-pad" style={{background: "var(--success-tint)", borderColor: "transparent", textAlign: "center"}}>
            <Icons.Check size={20}/>
            <div className="slog-h3 mt-2">All caught up for today.</div>
  ...
  const HeatmapBlock = (
    <div className="card card-pad">
      <div className="row between">
        <div>
          <div className="slog-h3">Activity heatmap</div>
    ...
    <>
      ...
      <UI.Modal open={showViewAll} onClose={() => setShowViewAll(false)} size="modal-lg">
        <div className="modal-head">
          ...
          <h2 className="slog-h2 mt-2">Today, rolled over and dismissed</h2>
        </div>
        <div className="modal-pad" style={{paddingTop: 0}}>
          <div className="col gap-4">
            {[
...
function TaskRow({t, i, onDismiss, onComplete, rolled, compact }: any) {
  return (
...
(window as any).ScreenDashboard = ScreenDashboard;
(window as any).DayView = DayView;
(window as any).SessionHeader = SessionHeader;
...
function PhaseBar({s, current, browseMode }: any) {
  const { go } = useApp();
  const items = [
...
function PowerplayBody({s, browseMode, onLockedClick }: any) {
  const { go } = useApp();
  const clusters = [
  ...
  return (
    <>
      <div className="row between mt-6">
        <div className="slog-h3">Foundation clusters · {hasOA ? 6 : 5}</div>
      ...
      <div className="row gap-3 wrap mt-3">
        ...
        onClick={() => browseMode ? onLockedClick(() => go("slog:cluster", { sid: s.id, cluster: c.key })) : go("slog:cluster", { sid: s.id, cluster: c.key })}>
            <div className="row between">
              <div className="slog-h3" style={{ fontSize: 15 }}>{c.label}</div>
        ...
        <button className="card card-hover" style={{
          ...
          <div className="row between">
            <div className="row gap-2" style={{alignItems: "center"}}>
              <Icons.Brain size={16}/>
              <div className="slog-h3" style={{ fontSize: 15 }}>Aptitude</div>
      ...
      <div className="row between mt-6">
        <div className="slog-h3" style={{ fontSize: 16 }}>Resume</div>
        ...
        <div className="row between">
          <div className="row gap-3">
            ...
            <div>
              ...
              <div className="slog-h3 mt-1" style={{ fontSize: 16 }}>Resume review</div>
            </div>
          </div>
          {!s.resume.uploaded ?
...
function FinalOverBody({s, browseMode, onLockedClick }: any) {
  ...
  return (
    <>
      ...
      {/* REQUIRED ACTIVITIES */}
      <div className="slog-h3 mt-6" style={{ fontSize: 15 }}>Required</div>
          ...
          <button className="card card-hover" style={{ padding: 20, textAlign: "left", cursor: "pointer" }}
            ...
            <div className="row between">
              <div className="row gap-3">
                ...
                <div>
                  <div className="slog-h3" style={{ fontSize: 15 }}>{FO.oaRound(s)?.name || "Online Assessment"}</div>
        ...
        <button className="card card-hover" style={{ padding: 20, textAlign: "left", cursor: "pointer" }}
          ...
          <div className="row between">
            <div className="row gap-3">
              ...
              <div>
                <div className="slog-h3" style={{ fontSize: 15 }}>Mock Interview</div>
                <div className="muted mt-1" style={{ fontSize: 12.5 }}>
          ...
          <button className="card card-hover" style={{ padding: 20, textAlign: "left", cursor: "pointer" }}
            ...
            <div className="row between">
              <div className="row gap-3">
                ...
                <div>
                  <div className="slog-h3" style={{ fontSize: 15 }}>{FO.gdRound(s)?.name || "Group Discussion"}</div>
                  <div className="muted mt-1" style={{ fontSize: 12.5 }}>
        ...
        <button className="card card-hover" style={{ padding: 20, textAlign: "left", cursor: "pointer" }}
          ...
          <div className="row between">
            <div className="row gap-3">
              ...
              <div>
                <div className="slog-h3" style={{ fontSize: 15 }}>Resume Review</div>
                <div className="muted mt-1" style={{ fontSize: 12.5 }}>
                  {!s.resume.uploaded ?
      ...
      {/* OPTIONAL */}
      <div className="slog-h3 mt-6" style={{ fontSize: 15 }}>Optional</div>
      <div className="mt-3">
        <button className="card card-hover" style={{ padding: 20, textAlign: "left", cursor: "pointer" }}
          ...
          <div className="row between">
            <div className="row gap-3">
              ...
              <div>
                <div className="slog-h3" style={{ fontSize: 15 }}>Foundation Adaptive Practice</div>
                <div className="muted mt-1" style={{ fontSize: 12.5 }}>
        ...
        <div className="card card-pad mt-6" style={{ background: "var(--success-tint)", border: "1px solid transparent" }}>
          <div className="row between wrap gap-3">
            <div className="row gap-3">
              ...
              <div>
                <div className="slog-h3">You're ready.</div>
...
function SiblingClusters({s, hide, inline }: any) {
  const { go } = useApp();
  const items = [
...
function Mini({label, v, tone }: any) {
  return (
...
(window as any).ScreenPhase = ScreenPhase;
...
function Step({n, label, state }: any) {
  const styles = {
...
function DiagnosticQuiz({cluster, sid, inModal }: any) {
  ...
  return (
    <div className="card card-pad" style={{marginTop: inModal ? 0 : 24, borderRadius: inModal ? 14 : undefined, boxShadow: inModal ? "0 8px 40px rgba(0,0,0,0.16)" : undefined}}>
      ...
      <div className="row between mt-2">
        <h3 className="slog-h2">Calibrate your skill tree</h3>
      ...
      <div className="card mt-4" style={{background: "var(--surface-2)", padding: 22, border: "1px solid var(--line-1)"}}>
        ...
        <div className="slog-h3 mt-3" style={{fontSize: 15, lineHeight: 1.5}}>{q.q}</div>
        <div className="col gap-2 mt-4">
          {q.choices.map((c, ci) => (
            <button key={ci}
...
function SkillTree({cluster, sid }: any) {
    ...
    <div className="mt-6">
      <div className="row between">
        <div>
          ...
          <h3 className="slog-h2 mt-2">Topics &amp; dependencies</h3>
        </div>
        <div className="row gap-3">
          <div className="segmented">
...
function SkillBranching({data, filter, sid, cluster }: any) {
  const { go } = useApp();
...
function SkillRadial({data, filter, sid, cluster }: any) {
  const { go } = useApp();
...
function SkillLinear({data, filter, sid, cluster }: any) {
  const { go } = useApp();
...
function TopicSummary({topic }: any) {
...
function TopicLink({topic }: any) {
  ...
  return (
    <>
      ...
      <div className="slog-h3 mb-3">{topic.name} — Concept Walkthrough</div>
...
function Practice() {
  ...
  return (
    <>
      ...
      <div className="slog-h3 mt-3" style={{fontSize: 15}}>{q.q}</div>
        ...
        <div className="viewport-inner fade-in" style={{maxWidth: 760}}>
          ...
          <div className="card card-pad mt-6">
            <div className="row between">
              <div>
                ...
                <div className="slog-h3 mt-2">2 days ago · 18 questions · 72% accuracy</div>
              </div>
          ...
          {!started ? (
            <div className="card card-pad mt-4">
              <div className="row between">
                <div className="col gap-2">
                  <div className="slog-h3">Start a new mixed set</div>
...
(window as any).ScreenCluster = ScreenCluster;
(window as any).ScreenTopic = ScreenTopic;
(window as any).ScreenAdaptive = ScreenAdaptive;
...
function WinspeakInline({q, compressed, onClose }: any) {
  ...
  return (
    <>
      <div className="modal-head">
        ...
        <h2 className="slog-h2 mt-2">{q.q}</h2>
      </div>
      <div className="modal-pad" style={{paddingTop: 0}}>
        {stage === "tips" && (
        ...
        <div className="viewport-inner fade-in">
          ...
          {running && (
            <div className="card card-pad fade-in">
              ...
              <h2 className="slog-h2 mt-2">{s.rounds[roundIdx].name}</h2>
              <div className="card card-pad mt-4" style={{background: "var(--surface-2)"}}>
                <div className="label">Interviewer prompt</div>
                <div className="slog-h3 mt-2" style={{fontSize: 16, lineHeight: 1.5}}>
            ...
            <div className="fade-in">
              ...
              <div className="row gap-3 wrap mt-6">
                <div className="card card-pad" style={{flex: "1 1 320px"}}>
                  <div className="slog-h3">Performance tips</div>
                ...
                <div className="card card-pad" style={{flex: "1 1 320px"}}>
                  <div className="slog-h3">Topic review</div>
                  <div className="col gap-2 mt-2">
                    {[
                      "Sharding strategies",
    ...
    <>
        ...
        <div className="viewport-inner fade-in">
          <div className="row between">
            ...
            {s.resume.uploaded && (
              <div className="col" style={{alignItems: "flex-end"}}>
                ...
                <div className="slog-h2 mt-1" style={{fontSize: 22}}>
          ...
          {!s.resume.uploaded && !scanning && (
            <div className="card card-pad mt-6" style={{textAlign:"center", padding: 40, border: "2px dashed var(--line-2)"}}>
              ...
              <div className="slog-h3 mt-3">Upload your resume to begin</div>
          ...
          {scanning && (
            <div className="card card-pad mt-6" style={{textAlign: "center", padding: 40}}>
              ...
              <div className="slog-h3 mt-3">Scanning resume against {s.role}</div>
          ...
          {s.resume.uploaded && !scanning && (
            <>
              ...
              <div className="slog-h3 mt-6">Detected gaps · {s.resume.gaps.length}</div>
              <div className="col gap-2 mt-3">
                {s.resume.gaps.map(g => (
      ...
      <UI.Modal open={showExisting} onClose={() => setShowExisting(false)}>
        <div className="modal-head">
          ...
          <h2 className="slog-h2 mt-2">Use your existing resume?</h2>
        </div>
        <div className="modal-pad" style={{paddingTop: 0}}>
...
(window as any).ScreenInterview = ScreenInterview;
(window as any).ScreenMockLegacy = ScreenMockLegacy;
(window as any).ScreenResume = ScreenResume;
...
// SO-20
function MarkCompleteModal({modal, onClose }: any) {
  ...
  return (
    <>
      <div className="modal-head">
        ...
        <h2 className="slog-h2 mt-2">Close “{s?.role}” session</h2>
...
// SO-22
function ExtendModal({modal, onClose }: any) {
  const { state, setState, showToast } = useApp();
  ...
  return (
    <>
      <div className="modal-head">
        ...
        <h2 className="slog-h2 mt-2">Pick a new interview date</h2>
        <p className="muted mt-2" style={{fontSize: 13}}>
...
// SO-23
function DuplicateModal({modal, onClose }: any) {
  return (
    <>
      <div className="modal-head">
        <div className="label">SO-23 · Duplicate role warning</div>
        <h2 className="slog-h2 mt-2">You already have a Slog Over for “{modal.role}”</h2>
        <p className="muted mt-2" style={{fontSize: 13}}>
...
function LowCompletionModal({modal, onClose }: any) {
  return (
    <>
      <div className="modal-head">
        <div className="label">Phase switch · low Foundation completion</div>
        <h2 className="slog-h2 mt-2">You may not be ready for Final Over</h2>
      </div>
      <div className="modal-pad" style={{paddingTop: 0}}>
        <div className="card card-pad" style={{background: "var(--warn-tint)", border: "1px solid #f5c89a"}}>
          <div className="row between">
...
function StartPhaseModal({modal, onClose }: any) {
  return (
    <>
      <div className="modal-head">
        <div className="label">US-4.1 · Switch active phase</div>
        <h2 className="slog-h2 mt-2">Switch active phase to {WUTIL.phaseLabel(modal.to)}?</h2>
        <p className="muted mt-2" style={{fontSize: 13}}>
...
(window as any).ModalRouter = ModalRouter;
(window as any).OfflineBanner = OfflineBanner;
...
function InterviewCuesModal({sid, onClose }: any) {
  const { state, setState, showToast } = useApp();
  const s = state.sessions.find(x => x.id === sid);
  if (!s) return null;
  ...
  return (
    <>
      <div className="modal-head">
        ...
        <h2 className="slog-h2 mt-2">Walk in focused.</h2>
        <p className="muted mt-2" style={{fontSize: 13}}>
        ...
        <div className="viewport-inner fade-in">
          ...
          {stage === "running" && (
            <div className="card card-pad fade-in" style={{maxWidth: 720, margin: "0 auto"}}>
              ...
              <h2 className="slog-h2 mt-3" style={{fontSize: 20, lineHeight: 1.4}}>{sectionQs[qi].q}</h2>
              <div className="col gap-2 mt-4">
          ...
          {stage === "done" && (
            <div className="fade-in" style={{textAlign: "center", padding: 40}}>
              <Icons.Sparkle size={32}/>
              <div className="slog-h3 mt-3">Loading results…</div>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="viewport-inner fade-in">
              ...
              <div className="row gap-3 wrap mt-6">
                {seq.map((r, i) => {
                  ...
                  return (
                    <button key={r.id} className="card card-hover" style={{
                      ...
                      <div className="slog-h3 mt-3" style={{fontSize: 16}}>{r.name}</div>
                      <div className="muted mt-2" style={{fontSize: 12.5}}>
                ...
                {FO.hasOA(s) && (
                  <div className="card" style={{flex: "1 1 280px", padding: 20, opacity: 0.55, background: "var(--surface-2)"}}>
                    ...
                    <div className="slog-h3 mt-3" style={{fontSize: 16, color: "var(--ink-3)"}}>{FO.oaRound(s)?.name}</div>
                ...
                {FO.hasGD(s) && (
                  <div className="card" style={{flex: "1 1 280px", padding: 20, opacity: 0.55, background: "var(--surface-2)"}}>
                    ...
                    <div className="slog-h3 mt-3" style={{fontSize: 16, color: "var(--ink-3)"}}>{FO.gdRound(s)?.name}</div>
                ...
                <div className="card card-pad mt-6" style={{background: "var(--surface-2)"}}>
                  <div className="row between gap-3 wrap">
                    <div>
                      ...
                      <div className="slog-h3 mt-1">Combined debrief is ready</div>
          ...
          {stage === "sim" && (
            <div className="card card-pad fade-in">
              ...
              <h2 className="slog-h2 mt-3">{seq[roundIdx].name}</h2>
              <div className="row gap-2 mt-2">
          ...
          {stage === "loading" && (
            <div className="card card-pad fade-in" style={{textAlign: "center", padding: 56, maxWidth: 560, margin: "40px auto"}}>
              ...
              <div className="slog-h3 mt-3">Analysing your performance…</div>
...
function DebriefView({s, fo, seq, onRunAgain, onBack }: any) {
  ...
  return (
    <div className="fade-in">
      ...
      <div className="row gap-3 wrap mt-4">
        <div className="card card-pad" style={{flex: "1 1 320px"}}>
          <div className="slog-h3">Improvement tips</div>
          <ul className="mt-2" style={{paddingLeft: 18, fontSize: 13.5, lineHeight: 1.7, color: "var(--ink-2)"}}>
...
(window as any).ScreenMock = ScreenMock; // overrides prep-resume.jsx version
(window as any).ScreenMockAssessment = ScreenMockAssessment;
(window as any).ScreenMockAssessmentResults = ScreenMockAssessmentResults;
(window as any).ScreenFOComplete = ScreenFOComplete;
(window as any).QuickTipsModal = QuickTipsModal;
(window as any).InterviewCuesModal = InterviewCuesModal;
(window as any).quickTipsFor = quickTipsFor;
(window as any).interviewCuesFor = interviewCuesFor;
      ...
      <div className="viewport">
        <div className="viewport-inner fade-in">
          ...
          {stage === "intro" && (
            <>
              ...
              <div className="card card-pad mt-6" style={{background: "var(--surface-2)"}}>
                ...
                <h2 className="slog-h2 mt-2" style={{fontSize: 20, lineHeight: 1.4}}>{topic.topic}</h2>
                <div className="muted mt-3" style={{fontSize: 12.5}}>
          ...
          {stage === "session" && (
            <div className="card card-pad fade-in">
              ...
              <div className="card card-pad mt-4" style={{background: "var(--surface-2)"}}>
                ...
                <div className="slog-h3 mt-1" style={{fontSize: 15, lineHeight: 1.4}}>{topic.topic}</div>
              </div>
          ...
          {stage === "loading" && (
            <div className="card card-pad fade-in" style={{textAlign: "center", padding: 56, maxWidth: 560, margin: "40px auto"}}>
              <Icons.Sparkle size={36}/>
              <div className="slog-h3 mt-3">Analysing your GD performance…</div>
...
(window as any).ScreenGDSimulation = ScreenGDSimulation;
(window as any).ScreenGDDebrief = ScreenGDDebrief;
                ...
                <div className="row between">
                  <div className="row gap-2" style={{alignItems: "center"}}>
                    ...
                    <div>
                      ...
                      <div className="slog-h3" style={{fontSize: 15}}>{c.name}</div>
                    </div>
                  </div>
...
function AptSkillTree({topics, onTopicClick }: any) {
  const tiers = [
...
function AptDiagnostic({apt, sub, onFinish }: any) {
  const total = 8;
    ...
    <div className="card card-pad" style={{borderRadius: 14, boxShadow: "0 8px 40px rgba(0,0,0,0.18)"}}>
      <div className="row between" style={{alignItems: "flex-start"}}>
        <div>
          ...
          <h2 className="slog-h2 mt-2">Calibrate your skill tree</h2>
        </div>
          ...
          {tab === "course" && (
            <div className="card card-pad fade-in col gap-3">
              <div>
                ...
                <h3 className="slog-h3">{topic.name} — Full Concept Walkthrough</h3>
              </div>
              <div style={{position: "relative", paddingBottom: "56.25%", height: 0, borderRadius: 10, overflow: "hidden", background: "#000"}}>
                <iframe
...
(window as any).ScreenAptitudeHub = ScreenAptitudeHub;
(window as any).ScreenAptitudeSub = ScreenAptitudeSub;
(window as any).ScreenAptTopic = ScreenAptTopic;
...
// ──────────────────────────────────────────────────────────────────────
function AccelerationBody({s, browseMode, onLockedClick }: any) {
  const { go } = useApp();
  const tech = ACC.technicalProgress(s);
  const beh = ACC.behavioralProgress(s);
  const apt = ACC.aptitudeProgress(s);
    ...
    <>
          ...
          <div className="row between">
            <div className="row gap-3">
              ...
              <div>
                ...
                <div className="slog-h3 mt-1" style={{fontSize: 15}}>{task.label}</div>
              </div>
            </div>
      ...
      <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 28}}>
        <div>
          ...
          <div className="slog-h3 mt-1" style={{fontSize: 15}}>Technical Topics <span className="dim" style={{fontSize: 12}}>· {WUTIL.pct(tech)}%</span></div>
        </div>
      </div>
      ...
      <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 28}}>
        <div>
          ...
          <div className="slog-h3 mt-1" style={{fontSize: 15}}>Behavioral Cluster <span className="dim" style={{fontSize: 12}}>· {WUTIL.pct(beh)}%</span></div>
        </div>
      </div>
        ...
        <div className="row between">
          <div className="row gap-3">
            ...
            <div>
              ...
              <div className="slog-h3 mt-1" style={{fontSize: 15}}>Behavioral practice cluster</div>
      ...
      <div style={{display: "flex", justifyContent: "space-between", alignItems: "center", marginTop: 28}}>
        <div>
          ...
          <div className="slog-h3 mt-1" style={{fontSize: 15}}>Aptitude Practice <span className="dim" style={{fontSize: 12}}>· {WUTIL.pct(apt)}%</span></div>
        </div>
      </div>
      <button className="card card-hover mt-3" style={{
        width: "100%", padding: 20, textAlign: "left", cursor: "pointer", background: "var(--surface)",
        ...
        <div className="row between">
          <div className="row gap-3">
            ...
            <div>
              ...
              <div className="slog-h3 mt-1" style={{fontSize: 15}}>Aptitude practice hub</div>
...
function Mini2({label, val, weight, tone }: any) {
  return (
          ...
          <div className="card card-pad mt-4" style={{background: "var(--accent-tint)", border: "1px solid var(--accent)"}}>
            <div className="row between gap-3 wrap">
              <div>
                ...
                <div className="slog-h3 mt-1">Interview Practice — {topic.name}</div>
                <div className="muted mt-1" style={{fontSize: 12.5}}>
              ...
              return (
                <div key={qa.id} className="card" style={{padding: 0, border: t ? `1.5px solid ${tagColor(t)}` : "1px solid var(--line-1)"}}>
                  <div style={{padding: "16px 20px"}}>
                    ...
                    <div className="slog-h3 mt-3" style={{fontSize: 15, lineHeight: 1.5}}>{qa.q}</div>
                    {!open && (
          ...
          <div className="card card-pad mt-4" style={{background: "var(--accent-tint)", border: "1px solid var(--accent)"}}>
            <div className="row between gap-3 wrap">
              <div>
                ...
                <div className="slog-h3 mt-1">Drill MCQs for {sub.name}</div>
      ...
      <div className="viewport">
        <div className="viewport-inner fade-in" style={{maxWidth: 760}}>
          ...
          <div className="card card-pad mt-4 fade-in">
            ...
            <div className="slog-h2 mt-3" style={{fontSize: 18, lineHeight: 1.5}}>{q.q}</div>
            <div className="col gap-2 mt-4">
              {q.choices.map((c, ci) => {
      ...
      <div className="viewport">
        <div className="viewport-inner fade-in">
          ...
          <div className="card card-pad mt-6">
            ...
            <div className="slog-h2 mt-3" style={{fontSize: 18, lineHeight: 1.5}}>{prompts[qi]}</div>
      ...
      <div className="viewport">
        <div className="viewport-inner fade-in" style={{maxWidth: 720}}>
          ...
          <div className="card card-pad mt-6">
            ...
            <div className="slog-h2 mt-3" style={{fontSize: 18, lineHeight: 1.5}}>{bq.q}</div>
      ...
      <div className="viewport">
        <div className="viewport-inner fade-in">
          ...
          <div className="card card-pad mt-6">
            ...
            <div className="slog-h2 mt-3" style={{fontSize: 18, lineHeight: 1.5}}>{prompts[qi].q}</div>
        ...
        <div className="viewport">
          <div className="viewport-inner fade-in" style={{maxWidth: 720}}>
            <div className="card card-pad fade-in">
              ...
              <h2 className="slog-h2 mt-3" style={{fontSize: 18, lineHeight: 1.5}}>{q.q}</h2>
              <div className="col gap-2 mt-4">
                {q.choices.map((c, i) => {
...
function MiniSparkline({values }: any) {
...
function SessionsTrend({values }: any) {
  const W = 720, H = 160;
  const max = 1, min = 0;
...
(window as any).AccelerationBody = AccelerationBody;
(window as any).ScreenAccTopic = ScreenAccTopic;
(window as any).ScreenAccSubtopic = ScreenAccSubtopic;
(window as any).ScreenAccMCQ = ScreenAccMCQ;
(window as any).ScreenAccCheatSheet = ScreenAccCheatSheet;
(window as any).ScreenAccWinSpeak = ScreenAccWinSpeak;
(window as any).ScreenAccWinSpeakReport = ScreenAccWinSpeakReport;
(window as any).ScreenAccBehavioral = ScreenAccBehavioral;
(window as any).ScreenAccBehSingle = ScreenAccBehSingle;
(window as any).ScreenAccBehPractice = ScreenAccBehPractice;
(window as any).ScreenAccBehReport = ScreenAccBehReport;
(window as any).ScreenAccAptHub = ScreenAccAptHub;
(window as any).ScreenAccAptType = ScreenAccAptType;

(window as any).ACC = ACC;

// Placeholder screens for other sidebar destinations + Tweaks panel

function ScreenPlaceholder({title, icon, blurb }: any) {
  return (
    <>
        ...
        <div className="viewport-inner fade-in">
          ...
          <div className="row gap-3 wrap mt-6">
            <button className="card card-hover" style={{flex: "1 1 280px", padding: 22, textAlign: "left", cursor: "pointer"}}
              ...
              <div className="slog-h3 mt-2">Today's tasks ({sessions[0]?.role})</div>
            ...
            <button className="card card-hover" style={{flex: "1 1 280px", padding: 22, textAlign: "left", cursor: "pointer"}}
              ...
              <div className="slog-h3 mt-2">All sessions</div>
            ...
            <button className="card card-hover" style={{flex: "1 1 280px", padding: 22, textAlign: "left", cursor: "pointer"}}
              ...
              <div className="slog-h3 mt-2">Start a new Slog Over</div>
...
(window as any).ScreenPlaceholder = ScreenPlaceholder;
(window as any).ScreenHome = ScreenHome;
(window as any).TweaksPanel = TweaksPanel;
...
export default function Learning() {
  ...
  return (
    <AppCtx.Provider value={ctx}>
      ...
      <div className="slog-root" style={{height:'100%',minHeight:0}}>
        <div className="main">
          <ScreenRouter/>
        </div>
