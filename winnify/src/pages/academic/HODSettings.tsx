        ...
        <CardContent className="p-6">
          ...
          <div className="space-y-4">
            {[
              ...
              { label: 'Course Updates', desc: 'Notifications about course changes' },
              { label: 'Approval Requests', desc: 'Get notified of pending approvals' },
              { label: 'Faculty Updates', desc: 'Updates from faculty members' },
            ].map((item, index) => (
